...
export default function ApprovedDoctorsList() {
  ...
  const handleDelete = async (id) => {
    if (!confirm("Delete this doctor permanently? This cannot be undone.")) return;
  ...
  if (doctors.length === 0) {
    return (
      <div className="bg-white p-10 rounded-2xl shadow text-center text-gray-600">
        <h3 className="text-xl font-medium">No approved doctors yet</h3>
        <p className="mt-2">Approved doctors will appear here.</p>
      </div>
    );
  }
